...
function Home2() {
    ...
    const recentCrafts = useSelector(state => state.products.availProds)
        ...
        <div>
            ...
            <section className="shop_section layout_padding">
                <div className="container">
                    ...
                    <div className="modal my-modal modal-xl " id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                        <div className="modal-dialog modal-dialog-centered w-75 mx-auto">
                            <div className="modal-content">
                                <div className="modal-header">
                                    <h5 className="modal-title" id="staticBackdropLabel">
                                        <i className="fa fa-shopping-cart" aria-hidden="true" style={{ color: 'red', marginRight: '20px' }}></i>
                                        Your Cart
                                    </h5>
                                ...
                                <div className="modal-body">
                                    <div className="contents">
                                        ...
                                        {
                                            cart.length > 0 ? <button className="btn btn-warning" onClick={clearCart}>Empty Cart</button> : ""
                                        }
                                    </div>
                        ...
                        <div className="col-lg-7 col-md-6 px-0">
                            <div className="map_container">
                                <div className="map-responsive">
                                    <iframe src="https://www.google.com/maps/embed/v1/place?key=AIzaSyA0s1a7phLN0iaD6-UE7m4qP-z21pH0eSc&q=Eiffel+Tower+Paris+France" width="600" height="300" frameborder="0" style={{ borde: '0', width: '100%', height: '100%' }} allowfullscreen></iframe>
                                </div>
                            </div>
                        </div>
